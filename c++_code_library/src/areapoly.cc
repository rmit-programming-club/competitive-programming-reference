...
// Author: Howard Cheng
//
// This routine returns the SIGNED area of a polygon represented
// as an array of n points (n >= 1). The result is positive if the
// orientation is counterclockwise,  and negative otherwise.
//
